...
export default function Navbar() {
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 glass-effect glass-highlight">
            ...
            {/* Mobile menu */}
            {menuAbierto && (
                <div className="md:hidden glass-effect glass-highlight border-t border-white/5 animate-fade-in">
