...
export default function VehicleCard({
    ...
    return (
        <Link href={`/catalogo/${id}`} className="group block h-full">
            <article className="glass-card glass-highlight overflow-hidden hover:border-accent/30 transition-all duration-300 hover-lift h-full flex flex-col relative">
